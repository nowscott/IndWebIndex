    ...
    <div className='app-background m-0 min-h-screen overflow-auto tracking-widest flex flex-col font-inherit'>
      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-12 sm:py-20 text-center">
        ...
        <div className="mb-12">
          ...
          <p className="text-base sm:text-lg text-slate-800 dark:text-zinc-400 leading-relaxed italic">
        ...
        <div className="grid sm:grid-cols-3 gap-6 mt-16 text-left">
          <div className="p-6 rounded-2xl bg-[linear-gradient(165deg,rgba(255,255,255,0.94),rgba(241,248,255,0.9))] dark:bg-[linear-gradient(165deg,rgba(42,42,46,0.92),rgba(28,28,30,0.95))] border border-slate-300 dark:border-zinc-700/90 shadow-sm hover:border-sky-400/50 transition-[background-color,border-color]">
            <HiOutlineSparkles className="w-8 h-8 text-sky-500 mb-4" />
            <h3 className="text-lg font-extrabold mb-2 text-sky-600 dark:text-zinc-100">独立精神</h3>
          ...
          <div className="p-6 rounded-2xl bg-[linear-gradient(165deg,rgba(255,255,255,0.94),rgba(241,248,255,0.9))] dark:bg-[linear-gradient(165deg,rgba(42,42,46,0.92),rgba(28,28,30,0.95))] border border-slate-300 dark:border-zinc-700/90 shadow-sm hover:border-cyan-400/50 transition-[background-color,border-color]">
            <HiOutlineHeart className="w-8 h-8 text-cyan-500 mb-4" />
            <h3 className="text-lg font-extrabold mb-2 text-cyan-600 dark:text-zinc-100">开源共建</h3>
            <p className="text-sm text-slate-700 dark:text-zinc-400 leading-relaxed">
