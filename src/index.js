window.onload = function () {
    ...
    if (currentHour >= 22 || currentHour < 8) {// 更改页面的背景颜色为深色
        document.getElementById('darkcss').href = "https://nowscott.top/home/css/dark.css"
        document.getElementById('icon').src = 'https://nowscott.top/home/svg/moon.svg'
    } else {
        document.getElementById('darkcss').href = "https://nowscott.top/home/css/daytime.css"
        document.getElementById('icon').src = 'https://nowscott.top/home/svg/sun.svg'
    }
